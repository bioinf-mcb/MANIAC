...
ls "${snakemake_params[CHUNK]}"* | parallel -j$JOBNB Rscript ${snakemake_params[SORTPATH]} {}

sort --parallel=${snakemake_params[MMSEQS_THREADS]} -m -k1,1 -k2,2 -k7,7g "${snakemake_params[INTERMEDIATE_FILES_DIR]}"/sorted_* > "${snakemake_params[MERGED]}"
